...
public class DynamicTestDemo {
		...
		// Junit brings to you a concept called as Dynamic tests, in which the tests will be generated at runtime
		...
		@TestFactory
		public Collection<DynamicTest> dynamicTests()  // here DynamicTest is class generating test case at runtime
		{
