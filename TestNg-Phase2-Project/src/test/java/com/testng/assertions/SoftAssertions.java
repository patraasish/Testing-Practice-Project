...
public class SoftAssertions {
	...
	public void GetTitle() // Called as a Test Method
	{
		...
		// the program
		softAssert.assertEquals(actualtitle, expectedtitle, "The title donot match");
		...
		softAssert.assertTrue(searchbox); // captures the assertion and it will continue to run the program
